...
def main():
    ...
    template_variables = {
        ...
        "$WATER_HULLS":      extract_hulls.get_water_hulls(os.path.join("output", levelname, "bsp.json"), bspguy_scale),
        "$MODEL_HULLS":      extract_hulls.get_model_hulls(os.path.join("output", levelname, "bsp.json"), bspguy_scale),
